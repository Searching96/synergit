...
| [#036](./issues/036-project-management-backend.md) | Closed | High | High | Backend | Project Management Backend | `feature`, `projects`, `api`, `database` | |
| [#037](./issues/037-project-management-frontend-integration.md) | In Progress | High | High | Frontend | Project Management Frontend Integration | `feature`, `projects`, `ui`, `api` | [#036](./issues/036-project-management-backend.md) |
